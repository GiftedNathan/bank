    ...
    <div class="m-auto bg-gray-50 px-4 py-6 my-6 rounded-2xl">
        ...
        <form action="{{ route('savings.store') }}" method="post"
            ...
            <div class="w-full mb-3">
                <label for="" class="text-sm font-semibold capitalize">Name</label>
                <select class="w-full border rounded-md pl-2 h-10" name="user_id" id="user_id">
            ...
            <div class="flex justify-end items-center gap-4">
                <button type="reset" class="rounded-md bg-red-600 px-6 py-2 capitalize text-slate-50 hover:bg-red-400">
                    clear input
                </button>
                inp
                <button type="submit"
